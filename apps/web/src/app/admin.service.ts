...
export class AdminService {
  ...
  listOrganisations(statut?: StatutOrganisation): Observable<OrganisationAdmin[]> {
    return this.http.get<OrganisationAdmin[]>('/admin/organisations', {
  ...
  listUtilisateurs(): Observable<UtilisateurAdmin[]> {
    return this.http.get<UtilisateurAdmin[]>('/admin/utilisateurs');
  }
