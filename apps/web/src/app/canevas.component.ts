...
import { ArchimateService, ElementArchimate, RelationArchimate, TypeElement, TypeRelation } from './archimate.service';
...
import { DataEntity, DonneesService } from './donnees.service';
